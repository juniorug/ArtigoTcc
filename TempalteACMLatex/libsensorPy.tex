...
\subsection{NewPing}
NewPing Library for Arduino\footnote{\url{https://code.google.com/p/arduino-new-ping/}}  is an ultrasonic sensor library for Arduino that was developed to work with the sensors SR04, SRF05, SRF06, DYP-ME007 and Parallax PING)))\textsuperscript{TM}. Intended to use with Sketches (Software written using Arduino), the library is written with C++.
\newline
\newline
Features:
\begin{itemize}
